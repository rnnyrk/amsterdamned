...
const BUNDLE_ID = 'com.amsterdamned'; // ios bundle id
const PACKAGE = 'com.amsterdamned'; // android package name
const NAME = APP_KEY_SUFFIX === 'PROD' ? 'Amsterdamned' : `Amsterdamned ${APP_KEY_SUFFIX}`; // app name
